...
export default function Footer() {
    return (
        <footer className="bg-slate-900 text-white pt-24 pb-12 overflow-hidden relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24 relative z-10">
                    <div className="space-y-8">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-3xl font-black tracking-tighter uppercase">Import<span className="text-primary text-xl ml-1">.</span></div>
                        </div>
                        <p className="text-slate-400 font-medium leading-relaxed max-w-xs">
                            Tu nexo directo con lo mejor de los productos internacionales. Importación garantizada, atención personalizada y envíos a todo el país.
                        </p>
                    ...
                    <div className="space-y-8">
                        <h4 className="font-black text-sm uppercase tracking-widest text-primary">Tienda</h4>
                        <ul className="space-y-4 text-slate-400 font-bold text-sm">
                            <li><Link href="/search?filter=new" className="hover:text-white transition-colors">Nuevos Productos</Link></li>
                    ...
                    <div className="space-y-8">
                        <h4 className="font-black text-sm uppercase tracking-widest text-primary">Soporte</h4>
                        <ul className="space-y-4 text-slate-400 font-bold text-sm">
                            <li><Link href="/shipping" className="hover:text-white transition-colors">Envíos y Entregas</Link></li>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            ...
                            <div className="bg-white/10 p-3 rounded-lg flex items-center justify-center h-12">
                                <div className="font-black text-[10px] text-white/50">MC</div>
                            </div>
                            <div className="bg-white/10 p-3 rounded-lg flex items-center justify-center h-12">
                                <div className="font-black text-[10px] text-white/50">MP</div>
                            </div>
                            <div className="bg-white/10 p-3 rounded-lg flex items-center justify-center h-12">
            ...
            <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-primary/5 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/4"></div>
        </footer>
    );
}
